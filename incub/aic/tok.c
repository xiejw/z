 ...
 */
static void
tok_process_line( struct tokenizer *p, char *buf, size_t len )
{
        ...
        char *mergable = base64_decode( buf, (size_t)( space_ptr - buf ) );
...
error_t
tok_load( struct tokenizer *p, const char *fname )
{
