...
main( void )
{
        ...
        /*
              // Exact cover problem: Cover all columns of a matrix exactly
           once.
              //
              //        1 2 3 4 5 6 7
           ...
           *)dlink_get_node_data( tbl, sols[1] ) ), "sol 1" ); EXPECT_TRUE( 0 ==
           strcmp( "r1", (char *)dlink_get_node_data( tbl, sols[2] ) ), "sol 2"
           );
